...
class Sdi2122406SpringApplicationTests {
    ...
    public void PR06C() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99A", "Josefo", "Perez", "77777", "77777");
    ...
    public void PR06E() {
        ...
        //Comprobamos el error de contraseña corto.
    ...
    public void PR06F() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999990B", "Josefo", "Perez", "77777", "777777");
    ...
    public void PR08() {
        ...
        PO_NavView.clickOption(driver, "Gestión de notas", "class", "nav-item dropdown active");
    ...
    public void PR09() {
        ...
        PO_NavView.clickOption(driver, "Gestión de usuarios", "class", "nav-item dropdown active");
        String checkText = "Agregar usuario";
        List<WebElement> result = PO_View.checkElementBy(driver, "text", checkText);
        Assertions.assertEquals(checkText, result.get(0).getText());
    }
    ...
    public void PR10() {
        ...
        PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
        //Rellenamos el formulario
        PO_LoginView.fillLoginForm(driver, "99999993D", "12345");
    ...
    public void PR11() {
        ...
        Assertions.assertEquals(checkText, result.get(0).getText());
        //Nos desconectamos
        PO_HomeView.clickOption(driver, "logout", "class", "Desconectar");
    ...
    public void PR13() {
        ...
        PO_LoginView.fillLoginForm(driver, "99999990A", "123456");
        String checkText = "Notas del usuario";
        List<WebElement> result = PO_View.checkElementBy(driver, "text", checkText); //SeleniumUtils.esperarSegundos(driver, 1);
        // Contamos las notas
    ...
    //P15. Loguearse como profesor y eliminar una nota.
    @Test
    @Order(21)
    public void PR15() {
        //Vamos al formulario de login.
